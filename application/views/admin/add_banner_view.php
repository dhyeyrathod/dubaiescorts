                        ...
                        <div class="tile-body">
                            <?php if ($this->session->flashdata('banner_success')) : ?>
                                <div class="alert alert-success text-center" role="alert">
                                  <strong><?= $this->session->flashdata('banner_success'); ?></strong>
                                </div>
                            <?php endif ; ?>
                            <?php if ($this->session->flashdata('banner_error')) : ?>
                                <div class="alert alert-danger text-center" role="alert">
                                  <strong><?= $this->session->flashdata('banner_error'); ?></strong>
                                </div>
                            <?php endif ; ?>
                            <?= form_open_multipart('admin/add_banner/process') ?>
                                ...
                                <div class="form-group col-md-10">
                                    ...
                                    <?php if ($this->session->flashdata('url_error')) : ?>
                                        <span><?= $this->session->flashdata('url_error'); ?></span>
                                    <?php endif ; ?>
                                </div>
                                <div class="form-group col-md-10">
                                ...
                                <?php if ($this->session->flashdata('image_error')) : ?>
                                        <span><?= $this->session->flashdata('image_error'); ?></span>
                                    <?php endif ; ?>
